...
const APPLY_PREVIEW_CHECKPOINTS = JOURNALED_OPERATION_CHECKPOINTS;
const APPROVAL_RECORD_CHECKPOINTS = JOURNALED_OPERATION_CHECKPOINTS;
const APPROVAL_CONSUME_CHECKPOINTS = JOURNALED_OPERATION_CHECKPOINTS;
export const APPLY_PUBLISH_CHECKPOINTS = unique(
	JOURNALED_OPERATION_CHECKPOINTS,
	["apply.before_cas", "apply.after_cas"],
);
export const APPLY_RESOLUTION_CHECKPOINTS = unique(
	["resolution.after_observation"],
	jsonWrite("journal_resolution"),
	jsonWrite("journal_resolution_head"),
	guardRemoval("journal_resolution_guard_remove"),
);
...
export const STAGE2_CHECKPOINT_CATALOG = Object.freeze({
	...
	apply_preview: APPLY_PREVIEW_CHECKPOINTS,
	approval_record: APPROVAL_RECORD_CHECKPOINTS,
	approval_consume: APPROVAL_CONSUME_CHECKPOINTS,
	apply_publish: APPLY_PUBLISH_CHECKPOINTS,
	apply_resolution: APPLY_RESOLUTION_CHECKPOINTS,
